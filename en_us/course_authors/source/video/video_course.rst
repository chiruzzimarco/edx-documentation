...
EdX recommends that you create or obtain transcript files that use plain text
only, and that do not include HTML markup, character entities such as
``&nbsp;``, or styling such as boldface or italics.
